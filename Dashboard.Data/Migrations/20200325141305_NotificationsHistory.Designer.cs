...
namespace Dashboard.Data.Migrations
{
    ...
    [Migration("20200325141305_NotificationsHistory")]
    partial class NotificationsHistory
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dashboard.Models.Notification", b =>
                {
                    ...
                    b.Property<int>("EmailProviderResponse")
                        .HasColumnType("int");

                    b.Property<string>("NotificationCauseMessage")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime>("NotificationSentDateTime")
                        .HasColumnType("datetime2");

                    b.Property<Guid>("PortalId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("PortalResponseId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Dashboard.Models.Portal", b =>
                {
                    ...
                    b.Property<string>("LastRequestErrorMessage")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("LastRequestResponseTime")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Dashboard.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            Name = "Main",
                            Password = "$MYHASH$V1$10000$BVhigK8Btzkg63LXGpIuTEOzgkxkHcbjAgOSTFIag+yJKs6e",
                            Surname = "User",
                            isPermanent = true
                        });
                });
            ...
            modelBuilder.Entity("Dashboard.Models.Notification", b =>
                {
                    b.HasOne("Dashboard.Models.Portal", null)
